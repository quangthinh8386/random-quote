...
export function QuoteBox() {
  ...
  return (
    <div
      className="col-lg-5 d-flex flex-column bg-white p-5 rounded-3 td-1500"
      id="quote-box"
    >
      <div className="col-10 text-center align-self-center td-1500">
        <blockquote
      ...
      <div className="d-flex justify-content-between td-1500">
